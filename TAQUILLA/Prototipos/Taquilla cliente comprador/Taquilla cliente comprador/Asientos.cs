...
namespace Taquilla_cliente_comprador
{
    public partial class frmAsientos : Form
    {
        ...
        {
            tiempo = Int32.Parse(txtrepA.Text);
        ...
        private void Timer2_Tick(object sender, EventArgs e)
        {
            ...
            {
                tiempo = tiempo - 1;
               txtcontA.Text = tiempo.ToString();
            }
        }

        private void TplPanel2_Paint(object sender, PaintEventArgs e)
        {
            ...
            private void Btn_confirmar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (contador > 0 && contador == prueba)
                {
                    ...
                    Frm_pago formulariopag = new Frm_pago();
                    formulariopag.txtRepc.Text = txtcontA.Text;
                    formulariopag.Show();
                    Visible = false;
                }
                else
